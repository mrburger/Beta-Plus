...
//This class stores variables that will be reused in Gui Classes
public class GuiHelper
{
	// Button Id of "Defaults" button
	static final int defaultId = 304;
	// Button Id of "Randomize" button
	static final int randomizeId = 301;
	// Button Id of "Done" button
	static final int doneId = 300;
	// Button Id of "Yes" button
	static final int confirmId = 306;
	// Button Id of "No" button
	static final int cancelId = 307;
	// Button Id Stronghold Button
	static final int strongholdId = 150;
	// Button Id of Mineshaft Button
