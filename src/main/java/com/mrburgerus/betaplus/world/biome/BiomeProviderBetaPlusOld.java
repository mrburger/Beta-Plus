...
public class BiomeProviderBetaPlusOld extends BiomeProvider
{
	// Fields
	...
	public BiomeProviderBetaPlusOld(World world, BetaPlusGenSettings settingsIn)
	{
	...
	public Biome[] generateBiomesTrue(int startX, int startZ, int xSize, int zSize)
	{
		...
		temperatures = temperatureOctave.generateOctaves(temperatures, (double) startX, (double) startZ, xSize, xSize, 0.02500000037252903, 0.02500000037252903, 0.25);
		humidities = humidityOctave.generateOctaves(humidities, (double) startX, (double) startZ, xSize, xSize, 0.05000000074505806, 0.05000000074505806, 0.3333333333333333);
	...
	public double[] getClimateValuesatPos(BlockPos pos)
	{
		...
		noise = noiseOctave.generateOctaves(noise, startX, startZ, xSize, xSize, 0.25, 0.25, 0.5882352941176471);
