...
public class ChunkGeneratorBetaPlus extends AbstractChunkGenerator<BetaPlusGenSettings>
{
	...
	public void makeBase(IChunk chunkIn)
	{
		...
		BetaPlusDeepenOcean.deepenOcean(chunkIn, this);
		// Replace Biomes
	...
	/* Spawns Passive Mobs, Not Working */
	@Override
	public void spawnMobs(WorldGenRegion region)
	{
		...
		//System.out.println("Biome: " + biome.getDisplayName().getString() + " @ " + i + ", " + j);
